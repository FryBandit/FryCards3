...
const MOCK_PACKS: PackType[] = [
  {
    id: 'pack_std_01',
    name: 'Standard Issue',
    description: 'Basic card crate containing standard operatives and equipment. Low chance of rare items.',
    cost_gold: 100,
    cost_gems: null,
    card_count: 5,
  ...
  },
  {
    ...
    description: 'High-grade data packet. Higher probability of encrypted rare cards.',
    cost_gold: null,
    cost_gems: 50,
    card_count: 5,
  ...
  },
  {
    ...
    description: 'The ultimate collection. Contains strictly high-tier cards from the source code.',
    cost_gold: null,
    cost_gems: 200,
    card_count: 10,
...
const Shop: React.FC = () => {
  ...
  const handleBuyPack = async (pack: PackType) => {
    ...
    try {
      ...
      console.error(err);
      if (mountedRef.current) setErrorMsg("Transaction failed. No funds were deducted.");
    } finally {
      if (mountedRef.current) setLoadingId(null);
    }
  };
